"""FROZEN — RommApiProtocol implementation for RomM 4.6.x.

This file represents the RomM 4.6.x API surface and MUST NOT be modified.
Enforcement: tests/test_api_freeze.py validates the file hash.

To add features for newer RomM versions, create or extend a version-specific
subclass (e.g. RommApiV47, RommApiV48) — never modify this file.
"""
